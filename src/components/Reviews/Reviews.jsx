    ...
    return (
        <section className="testimonial-section pt-120 pb-120">
            <div className="shapes">
                <div className="shape-1"><img src="./src/assets/images/shapes/testi-shape-1.png" alt="testi" /></div>
                <div className="shape-2"><img src="./src/assets/images/shapes/testi-shape-2.png" alt="testi" /></div>
            </div>
