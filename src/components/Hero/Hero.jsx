    ...
    return (
        <section className="hero-section-2 overflow-hidden py-2">
            {/* <div className="hero-bg-wrap">
                <div className="hero-bg"><img src="/images/bg-img/hero-bg.png" alt="hero" /></div>
                <div className="hero-bg-shape"><img src="/images/shapes/hero-bg-shape.png" alt="hero" /></div>
                <div className="faq-text-box">
                    <h4 className="student">Instructor</h4>
                    <div className="faq-thumb-list-wrap">
                        <ul className="faq-thumb-list">
                            <li><img src="/images/images/faq-thumb-1.png" alt="faq" /></li>
                            <li><img src="/images/images/faq-thumb-2.png" alt="faq" /></li>
                            <li><img src="/images/images/faq-thumb-3.png" alt="faq" /></li>
                            <li><img src="/images/images/faq-thumb-4.png" alt="faq" /></li>
                            <li><img src="/images/images/faq-thumb-5.png" alt="faq" /></li>
            ...
            <div className="shapes">
                <div className="shape shape-1"><img src="/images/shapes/hero-shape-11.png" alt="shape" /></div>
                <div className="shape shape-2"><img src="/images/shapes/hero-shape-12.png" alt="shape" /></div>
            </div>
                        ...
                        <div className="hero-content-2">
                            ...
                            {/* <div className="about-counter-items mb-0 wow fade-in-bottom" data-wow-delay="600ms">
                                <div className="about-counter-item">
                                    <div className="icon"><img src="/images/icon/about-1.png" alt="about" /></div>
                                    <div className="content">
                                ...
                                <div className="about-counter-item">
                                    <div className="icon"><img src="/images/icon/about-2.png" alt="about" /></div>
                                    <div className="content">
                            ...
                            <div className="cta-btn-wrap wow fade-in-bottom flex justify-content-center" data-wow-delay="500ms">
                                <Link to="/contact" className="ed-primary-btn cta-btn">Contact Us<i
